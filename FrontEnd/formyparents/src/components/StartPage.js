      ...
      <div className='sharing'>
        ...
        <div className='sharing-buttons'>
          ...
          <button className='sharing-button kakao'>
            ...
            <path d="M20.6025 9.84C13.5263 9.84 7.78998 14.346 7.78998 19.9044C7.78998 23.498 10.1881 26.6512 13.7956 28.4318C13.5993 29.1061 12.5344 32.7698 12.492 33.0576C12.492 33.0576 12.4665 33.2739 12.6071 33.3563C12.7477 33.4388 12.913 33.3747 12.913 33.3747C13.3161 33.3187 17.5875 30.3295 18.3268 29.8105C19.0653 29.9147 19.8258 29.9688 20.6025 29.9688C27.6787 29.9688 33.415 25.4629 33.415 19.9044C33.415 14.346 27.6787 9.84 20.6025 9.84Z" fill="black" fill-opacity="0.9"/>
            </svg>
            <span>카톡공유</span>
          </button>
        </div>
